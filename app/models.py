...
class App_User(models.Model):
    ...
    app_user_type = models.TextField(blank=True, null=True)
    auth_user_key = models.IntegerField(max_length=11, blank=True, null=True)
    vendor_id = models.IntegerField(max_length=11, blank=True, null=True)
    dg_id = models.IntegerField(max_length=11, blank=True, null=True)
...
class Vendor(models.Model):
    ...
    app_user = models.ForeignKey(App_User, unique=False)
    ...
    other_phone = models.SmallIntegerField(blank=True, null=True, max_length=10)
    primary_app_user_id = models.TextField(blank=True, null=True)
...
class Currier(models.Model):
    ...
    app_user = models.ForeignKey(App_User, unique=True)
...
class Order(models.Model):
    ...
    dg = models.ForeignKey(Currier, unique=False)
    ...
    deliv_zip = models.SmallIntegerField(blank=True, null=True, max_length=5)
    deliv_cross_street = models.TextField(blank=True, null=True)
...
class Device(models.Model):
    dev_id = models.AutoField(max_length=11, primary_key=True)
    dg = models.ForeignKey(Currier, unique=False)
...
class Form(models.Model):
    ...
    form_inputs = models.TextField(blank=True, null=True)
